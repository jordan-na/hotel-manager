...
const SelectionStatus = ({ selectedItems, reservationType, onDelete, onUnselectAll }) => {
   ...
   return (
      <div className={`${classes["selection-status"]} ${selectedItems.length > 0 ? classes.show : ""}`}>
         ...
         <div className={classes["button-group"]}>
            ...
            <Button size="xs" css={{padding: "1.2rem 2rem"}} flat color="error" onPress={deleteItemsHandler}>
               Delete
            </Button>
         </div>
      </div>
